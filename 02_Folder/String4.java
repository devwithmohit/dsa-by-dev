...
public class String4 {
    public static void main(String[] args) {
        // Anagram means 2 strings ke paas same characters hon,
        // but order can be different.
        // matlab order aage peeche ho sakta hai but two words me same character hone
        // chiaye
        // Har character ka count same ho (frequency match kare)
